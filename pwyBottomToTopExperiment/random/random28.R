...
j=28 #Need to chage this guy to the above j and change the following k to like 5000. And then run that using super computer
...
tag=ECK.Pathway_table$Pathway[indices]
