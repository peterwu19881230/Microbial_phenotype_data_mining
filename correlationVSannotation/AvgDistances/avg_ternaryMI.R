...
barplot(c(0.00062,0.014,0.014,0.039,0.057))
...
pdf(file=paste(dir_of_workingScript,file="avg_ternaryMI.pdf",sep="/"),height=8,width=15)
p
dev.off()


#a zoomed-in plot => this doesn't help the visualization at all
ggplot() +
