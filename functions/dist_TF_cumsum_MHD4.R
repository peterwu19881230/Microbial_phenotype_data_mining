...
dist_TF_cumsum_MHD4=function(data,ternary=F,thresh=NULL,attribute_list){
  ...
  MHD4_mat=modified_hamming_distance_4(ternaryData) 
  MHD4_melted=melt_dist(MHD4_mat)
  
  
  distance_table=MHD4_melted
  
  
  names(distance_table)[3:(dim(distance_table)[2])]=c("MHD4")
