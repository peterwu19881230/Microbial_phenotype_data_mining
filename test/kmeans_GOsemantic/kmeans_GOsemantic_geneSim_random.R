...
#In order to do random control: scramble the ids 
set.seed(102)
goea[,1]=sample(goea[,1])
...
GOEA_semantic_DF_geneSim_random=resultDF
#save(GOEA_semantic_DF_geneSim_random,file="Data/GOEA_semantic_DF_geneSim_random.RData")
...
Table=GOEA_semantic_DF_geneSim_random[,c("k","sim")] 
...
pdf(file=paste(currentDir,"kmeans_GOBPsemantic_geneSim_random.pdf",sep="/"),width=8, height=5)
