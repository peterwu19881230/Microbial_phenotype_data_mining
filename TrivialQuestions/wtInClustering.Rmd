...
hclust_pcc_complete %>% as.dendrogram %>% set("by_labels_branches_col", value = indices) %>% plot(ylab="distance")
## There must be a way to remove the messy x-label but I don't know (Tried plot(ann=F), plot(yaxt='n'). They don't work)
